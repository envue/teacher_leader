...
class TimeEntryApiController extends Controller
{
    public function index()
    {
        ...
        return new TimeEntryResource(TimeEntry::with(['work_type', 'population_type', 'caseload_type', 'created_by'])->get());
    }
    ...
    public function show(TimeEntry $timeEntry)
    {
        ...
        return new TimeEntryResource($timeEntry->load(['work_type', 'population_type', 'caseload_type', 'created_by']));
    }
