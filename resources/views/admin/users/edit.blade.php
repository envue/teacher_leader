    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_calendar') ? 'is-invalid' : '' }}" type="text" name="google_calendar" id="google_calendar" value="{{ old('google_calendar', $user->google_calendar) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('disabled_work_types') ? 'is-invalid' : '' }}" name="disabled_work_types[]" id="disabled_work_types" multiple>
                    @foreach($disabled_work_types as $id => $disabled_work_types)
                        <option value="{{ $id }}" {{ (in_array($id, old('disabled_work_types', [])) || $user->disabled_work_types->contains($id)) ? 'selected' : '' }}>{{ $disabled_work_types }}</option>
                    @endforeach
                </select>
