    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-work-types.update", [$timeWorkType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $timeWorkType->description) }}">
            ...
            <div class="form-group">
                ...
                <div id="color-picker" class="input-group my-colorpicker2 colorpicker-element col-6" data-colorpicker-id="2" style="margin-bottom:10px;">
                    <input type="text" autocomplete="off" class="form-control" data-original-title="Color" title="Color" name="color" id="color" value="{{ old('color', $timeWorkType->color) }}">
                        <div class="input-group-append">
                        <span class="input-group-text my-color-picker2 colorpicker-element"><i class="fas fa-square"></i></span>
                        </div>
                </div>
            </div>
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_population_type') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_population_type" id="use_population_type" value="1" {{ $timeWorkType->use_population_type || old('use_population_type', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_caseload_type') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_caseload_type" id="use_caseload_type" value="1" {{ $timeWorkType->use_caseload_type || old('use_caseload_type', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('system_value') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="system_value" id="system_value" value="1" {{ $timeWorkType->system_value || old('system_value', 0) === 1 ? 'checked' : '' }}>
