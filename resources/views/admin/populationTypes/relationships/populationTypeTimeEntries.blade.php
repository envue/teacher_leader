    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-populationTypeTimeEntries">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($timeEntries as $key => $timeEntry)
                            <tr data-entry-id="{{ $timeEntry->id }}">
                                ...
                                <td>
                                    {{ $timeEntry->population_type->name ?? '' }}
                                </td>
                                <td>
                                    @can('time_entry_show')
...
@endcan
  ...
  let table = $('.datatable-populationTypeTimeEntries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
